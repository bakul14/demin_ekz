...
------------------------------------------------------------------------------------------------------------------------------------
    ...
    "abcdefg\th" = "abcdefg h"      'g' стоит на 7 позиции, дальше идет (8-7=1) пробел, и на 9 позиции стоит символ 'h'

    Заметьте, что кол-во пробелов в двух вышепривеленных случаях разное, это нужно будет объяснить Демину.
------------------------------------------------------------------------------------------------------------------------------------
